...
export const COMPLETE_IMAGE_MAPPING: Record<string, { url: string }> = {
  ...
  'black-mamba': { url: 'https://images.unsplash.com/photo-1572317584569-f652a3350a69?w=400&h=400&fit=crop' },
  'king-cobra': { url: 'https://images.unsplash.com/photo-1570741066052-817a9b3a9e18?w=400&h=400&fit=crop' },
  ...
  'reticulated-python': { url: 'https://images.unsplash.com/photo-1504450874802-0ba2bcd659e3?w=400&h=300&fit=crop' },

  // ═══════════════════════════════════════════
  // REPTILES — LIZARDS
  // ═══════════════════════════════════════════
  'komodo-dragon': { url: 'https://images.unsplash.com/photo-1567569424971-2560757bfa4e?w=400&h=400&fit=crop' },
  'monitor-lizard': { url: 'https://images.unsplash.com/photo-1567569424971-2560757bfa4e?w=400&h=300&fit=crop' },
