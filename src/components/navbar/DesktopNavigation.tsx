...
const DesktopNavigation = () => {
  return (
    <div className="hidden md:ml-6 md:flex space-x-8">
      ...
      <Link to="/community" className="inline-flex items-center px-1 pt-1 border-b-2 border-white text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
        Community
      </Link>
    </div>
  );
